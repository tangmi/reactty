...
function registerNewHelper(helperName, helperFn) {
	Handlebars.registerHelper(helperName, helperFn);
}

module.exports.registerDefaultHelpers = registerDefaultHelpers;
module.exports.registerNewHelper = registerNewHelper;